...
(function () {
  ...
  var DICTS = {
    en: {
      ...
      'Locatie wordt bepaald…': 'Determining your location…',
      'Uw browser geeft uw locatie niet vrij. Sta locatie toe in uw browserinstellingen, of vul een postcode in.': 'Your browser is not sharing your location. Allow location access in your browser settings, or enter a postcode.',
      'Uw locatie kon niet worden bepaald. Vul een postcode of plaats in.': 'Your location could not be determined. Please enter a postcode or town.',
    ...
    es: {
      ...
      'Locatie wordt bepaald…': 'Determinando su ubicación…',
      'Uw browser geeft uw locatie niet vrij. Sta locatie toe in uw browserinstellingen, of vul een postcode in.': 'Su navegador no comparte su ubicación. Permita el acceso a la ubicación en la configuración de su navegador o introduzca un código postal.',
      'Uw locatie kon niet worden bepaald. Vul een postcode of plaats in.': 'No se ha podido determinar su ubicación. Introduzca un código postal o una localidad.',
